/**
 * This class is a JUnit Java Program that checks to see if all variables
 * are declared before they are used, testing to see if a type is assigned
 * to every StatementNode, and adding a type onto the ExpressionNodes of
 * the syntax tree.
 *
 * @author Cohl Dorsey
 */
...
public class SemanticAnalyzerTest
{
    ...
    /* This method uses JUnit to test the good method from the

...
public class SemanticAnalyzer
{
    ...
    /**
     * This function checks to see if the type of a declared variable
     * matches across assignment. A variable should be the same type as
     * its expression, unless the variable is of type real. If a variable
     * is declared as a real, then it is able to also hold an integer value,
    ...
    /**
     * This function checks to see if a variable has been declared.
    ...
    /**
     * This function that specifies if code will be generated by the code
     * generator or not.
